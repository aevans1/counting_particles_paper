...
from recovar import simulator, output, dataset
import prody
reload(simulator)
...
def main():
    ...
    parser.add_argument("--output_folder", default="/mnt/home/levans/ceph/Bad_Histogram/spike_synthetic/recovar_experiments", type=str)
    parser.add_argument("--pdb_folder", default="/mnt/home/levans/ceph/Bad_Histogram/spike_synthetic/spike_models_for_bad_histogram/all_atom/without_glycans", type=str)
    ...
    for idx, noise_level in enumerate(noise_levels):
        ...
        _, sim_info = simulator.generate_synthetic_dataset(dataset_folder, voxel_size, volume_folder, n_images,
